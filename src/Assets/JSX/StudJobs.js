                      ...
                      <div className="card jobcards ">
                          ...
                          <div className="card-body">
                            ...
                            <span className="view_button">
                              <button className="btn btn-outline-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#off1" aria-controls="offcanvasWithBothOptions">View Details</button>
                        ...
                        <div className="card jobcards">
                          ...
                          <div className="card-body">
                            ...
                            <span className="view_button">
                              <button className="btn btn-outline-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#off2" aria-controls="offcanvasWithBothOptions">View Details</button>
